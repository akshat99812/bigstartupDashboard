...
import { isReviewEditing, reviewCancelBtnState, reviewData} from "../atoms"
        ...
        <div className='flex justify-between'>
              ...
              <div className='flex gap-4'>
                ...
                <div>
                  ...
                  onClick={isEditing==false?handleSave:handleEdit}>Submit</button>
                </div>
              </div>
            </div>
            <div className='my-2'>
